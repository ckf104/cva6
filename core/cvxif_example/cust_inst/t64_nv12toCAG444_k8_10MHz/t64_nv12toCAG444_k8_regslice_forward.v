...
module t64_nv12toCAG444_k8_regslice_forward
#(parameter 
    DataWidth=32
)(
    input ap_clk ,
...
t64_nv12toCAG444_k8_regslice_obuf #(
  .W(W)
)
regslice_obuf_inst(
  .clk(ap_clk),
...
module t64_nv12toCAG444_k8_regslice_forward_w1
#(parameter 
    DataWidth=1
)(
    input ap_clk ,
...
module t64_nv12toCAG444_k8_regslice_obuf
#(
    parameter W=32
)(
    input clk ,
